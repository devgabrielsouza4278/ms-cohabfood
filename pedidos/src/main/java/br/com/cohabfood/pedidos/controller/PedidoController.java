package br.com.cohabfood.pedidos.controller;

import br.com.cohabfood.pedidos.dto.PedidoDto;
import br.com.cohabfood.pedidos.dto.StatusDto;
import br.com.cohabfood.pedidos.service.PedidoService;
...
public class PedidoController {
        ...
        @GetMapping("/porta")
        public String porta (@Value("${local.server.port}") String port) {
